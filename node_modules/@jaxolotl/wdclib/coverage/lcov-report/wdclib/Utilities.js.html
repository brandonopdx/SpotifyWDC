...
<html lang="en">
<head>
    <title>Code coverage report for wdclib/Utilities.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\index.html">All files</a> / <a href="index.html">wdclib</a> Utilities.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    for (let key in src) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof src[key] === 'function') {
            dest[key] = src[key];
        }
    }
}
